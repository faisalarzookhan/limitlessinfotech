...
/**
 * Handles GET requests to fetch approval requests.
 * @param request - The incoming request object.
 * @returns A JSON response with the approval requests or an error.
 */
...
/**
 * Handles POST requests to create a new approval request.
 * @param request - The incoming request object.
 * @returns A JSON response with the new approval request or an error.
 */
...
/**
 * Handles PUT requests to update an existing approval request.
 * @param request - The incoming request object.
 * @returns A JSON response with the updated approval request or an error.
 */
...
/**
 * Handles DELETE requests to delete an approval request.
 * @param request - The incoming request object.
